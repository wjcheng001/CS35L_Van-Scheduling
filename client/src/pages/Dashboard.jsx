      ...
      <main className="flex-grow max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              onClick={handleReturnVan}
              className="px-6 py-2 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 transition-colors duration-200 flex items-center space-x-2"
            >
              <svg 
                className="w-5 h-5" 
                fill="none" 
              ...
              <span>Return Van</span>
            </button>
          </div>
          
          {returns.length === 0 ? (
            <div className="bg-white border border-gray-200 rounded-xl p-6 text-center">
              <p className="text-gray-600 mb-4">No van returns to display.</p>
              <p className="text-sm text-gray-500">
                When you need to return a van, click the "Return Van" button above to start the return process.
              </p>
            </div>
          ) : (
